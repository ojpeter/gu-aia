...
$invariants = [
    ...
    ['id' => 'INV-4', 'text' => 'Disclosure, before the first answer.',
        'state' => 'tested', 'note' => 'server-rendered, precedes form and answer, no way to suppress it'],
    ...
    ['id' => 'INV-9', 'text' => 'It works on a bad connection.',
        'state' => 'tested', 'note' => '5.5 KB of CSS+JS against a 60 KB budget; no-JS form post works'],
